    ...
    blocks: [
      ...
      { kind: 'heading', text: 'What you can install and run today' },
      {
        ...
        rows: [
          ...
          ['Wallets', 'The in-game panel ships in `kei-transaction@0.8.0` (`@keicoin/wallet@0.5.1`). The standalone wallet, forked from BananoVault, is [kei-wallet](https://github.com/keicoin-org/kei-wallet) — `npm ci && npm test && npm run build` succeed on a clean clone, confirmed at `kei-wallet@2b16d32`, and its market panel is wired to `kei.market`, showing that wallet’s own offers, cancellable, and its settled trades. The network’s book stays unshowable: an offer lives on its author’s chain and Kei ships no indexer, so the panel says that rather than presenting a handful of offers as the market.'],
