  ...
  --plan-only`,
      ...
      { kind: 'heading', text: 'Known and stated plainly' },
      {
        ...
        items: [
          ...
          '**The 0.8.0 SDK release is installable, and it reaches the whole registry.** Re-run on 4 August 2026 in an empty directory — `npm init -y && npm install kei-transaction` — rather than read off a checkout or off registry metadata. The resolved tree is `kei-transaction@0.8.0` over `@keicoin/core@0.5.0`, `work@0.4.1`, `claims@0.5.1`, `tokens@0.5.2`, `market@0.4.0`, `wallet@0.5.0`, `economy@0.2.2` and `player-economy@0.1.2`, and importing the umbrella from that install gives a client whose `shop`, `economy`, `market`, `items` and `claims` namespaces are all present. The `0.6.0` release was the first umbrella to close the split with the registry; `0.8.0` carries the coordinated market-safety graph and exact book ranking forward. Create Kei MMO is not released; npm still serves the superseded `create-kei-game@0.2.0` scaffolder, which is a different product, and nothing is published as `create-kei-mmo`.',
