...
await kei.claims.pending()` },
...

  {
    ...
    blocks: [
      { kind: 'prose', text: 'Kei has a **public testnet that carries M4 claims and M5 swaps**, measured on 3 August 2026 rather than inferred from CI. The installable SDK set is version 0.4.0; item stats, the roll-supply fix and all three scaffolder templates are published with it.' },
      {
        kind: 'table',
        head: ['', 'State'],
        rows: [
          ...
          ['Installable vs merged', '`kei-transaction` and the SDK packages are published at 0.4.0, `@keicoin/market` at 0.1.1, and `create-kei-game` at 0.2.0. That closes the earlier registry gap: item stats, their roll-supply fix, and all three scaffolder templates are installable.'],
      ...
      { kind: 'heading', text: 'Known and stated plainly' },
      {
        ...
        items: [
          ...
          '**The 0.4.0 release is installable.** The SDK package set, market 0.1.1, and `create-kei-game` 0.2.0 were verified against the registry on 3 August 2026.',
