  ...
  <div class="split-evidence">
    <div class="limits">
      ...
      <ul>
        ...
        <li><strong>Create Kei MMO does not produce a working game yet.</strong> It is an unpublished draft: it plans a project and runs one bounded pass at the first step of that plan. Of its ${HARNESS_CRITERIA_COUNT} written criteria, criterion 1 partly holds and criterion 2 is met for fresh blank 2D and 3D projects. Static HTTP probes do not execute a headless client or prove criterion 3's game connection; 4–6 and 9 remain open, 7 is open end to end, and 8 is structurally advanced but not met.</li>
