...
<section><div class="wrap split">
  ...
  <div class="split-evidence">
    <div class="limits">
      ...
      <ul>
        <li><strong>What you can install is <code>kei-transaction@0.8.0</code></strong>, with the coordinated <code>@keicoin/*</code> release graph beneath it. Item stats, the roll-supply fix, <code>token.burn()</code>, <code>kei.economy</code> recipes and loot-table drops, <code>kei.shop</code> — the player-owned stall, through the player's own key — and <code>@keicoin/market@0.4.0</code> all install with it.</li>
