  ...
  <div class="split-evidence">
    <div class="limits">
      ...
      <ul>
        ...
        <li><strong>Create Kei MMO does not produce a complete working MMO yet.</strong> It is an unpublished draft: it plans a project and runs one bounded pass at the first step of that plan. At draft integration checkpoint <code>60af518</code>, criteria 2–4 are met for fresh blank 2D and 3D projects: they install, build, start an authoritative game server, and prove two headless clients see each other move. Criteria 5, 6, 8, and 9 remain open; 7 remains open end to end.</li>
