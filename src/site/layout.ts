...
const GITHUB_REPO = 'https://github.com/keicoin-org/keicoin-site'
...
<a class="github-link" href="${GITHUB_REPO}" target="_blank" rel="noopener noreferrer" aria-label="Kei on GitHub" title="Kei on GitHub">
